...
def sample_requests(
    ...
    generation_config_list = [
        GenerationConfig(
            temperature=1.0, top_p=1.0, max_tokens=150, response_format=response_format
        )
...
def benchmark(args: argparse.Namespace):
    ...
    # TODO (yongwww): generalize the input token size as llmperf
    if args.num_prompts > 1:
        prompts = [[1] * 3200 for _ in range(args.num_prompts)]
    elif args.num_prompts == 1:
        prompts = [1] * 3200
